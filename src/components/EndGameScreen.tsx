        ...
        <div className="content">
          <div className="col-12 d-flex justify-content-center align-items-center">
            <div>
              ...
              >
                Você {props.isGameWon ? "acertou!" : "não conseguiu..."}
              </h1>
              {/* <p className='text-center mb-1'>o Letreco do dia era: <b>{props.dailyWord.word}</b></p> */}
              <p className="text-center mb-3">
                você usou <b>{props.guesses.length} de 6</b> tentativas
              </p>
          ...
          <div className="col-12 mt-4 mt-md-0 d-flex flex-column align-items-center">
            <StatisticsView />
          </div>
        </div>
      }
